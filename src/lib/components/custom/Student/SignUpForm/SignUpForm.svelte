...
>
  <Form.Field {form} name="name" class="form-field">
    <Form.Control let:attrs>
      ...
      <Input {...attrs} bind:value={$formData.name} class="form-input" />
    </Form.Control>
  ...
  <Form.Field {form} name="email" class="form-field">
    <Form.Control let:attrs>
      ...
      <Input type="email" {...attrs} bind:value={$formData.email} class="form-input" />
    </Form.Control>
  ...
  <Form.Field {form} name="retype" class="form-field">
    <Form.Control let:attrs>
      ...
      <Input type="password" {...attrs} bind:value={$formData.retype} class="form-input" />
    </Form.Control>
  ...
  <div class="flex flex-wrap justify-start">
    ...
    <a href="/student/login" class="login-link">Login</a>
  </div>
</form>
